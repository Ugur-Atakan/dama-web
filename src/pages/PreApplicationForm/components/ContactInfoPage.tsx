...
interface ContactInfoPageProps {
  onBack: () => void;
  onContinue: (contactInfo: { firstName: string; lastName: string; email?: string; birthDate: string }) => void;
}

const ContactInfoPage: React.FC<ContactInfoPageProps> = ({ onBack, onContinue }) => {
