      ...
      <div className="max-w-md w-full bg-white rounded-2xl shadow-lg p-6 sm:p-8 my-8">
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center justify-center gap-4">
            ...
            <span className="text-gray-500 text-sm">{t('intro.or')}</span>
            <div className="h-px bg-gray-300 flex-1"></div>
          </div>

          <button
            onClick={() => {/* Navigate to login */}}
            className="w-full bg-white text-[#292A2D] py-4 rounded-xl font-medium 
              border-2 border-[#292A2D] hover:bg-gray-50 transition-all duration-300 text-lg"
          >
            {t('intro.login')}
          </button>
        </div>
